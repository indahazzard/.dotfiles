...
nnoremap('<leader>xd', "<cmd>:Trouble diagnostics toggle focus=false filter.buf=0<CR>", { silent = false, desc = "Show document diagnostics"})
nnoremap('<leader>xq', function() require("trouble").toggle("quickfix") end, { silent = false, desc = 'Show document quickfix'})
